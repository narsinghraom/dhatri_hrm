	...
	<nav class="navbar navbar-expand-sm bg-dark fixed-top navbar-dark">
		...
		<div class="navbar-header">
  		...
  		<ul class="navbar-nav ml-auto">
    		<li class="nav-item active"><a class="nav-link"  href="EmployeeView.jsp"><strong>Home</strong></a></li>
    		<li class="nav-item active"><a class="nav-link" href="Aboutus.jsp"><strong>Aboutus</strong></a></li>
  			<li class="nav-item active"><a class="nav-link" href="Home.jsp"><strong>Logout</strong></a></li>
