...
function clearForm()
	{ 	
		...
		document.getElementById("expectedCTC").innerHTML="";
...
{
	document.getElementById("Gender").innerHTML="please select atleast one value"
	return false;
}
...
else if(alternatemobileNumber==null||alternatemobileNumber=="")
{
	...
	document.getElementById("amobileno").innerHTML="plese enter the alternate mobile number"
	return false;
}
...
else if(Expectedctc==null||Expectedctc=="")
{
	document.getElementById("Expectedctc").innerHTML="please enter Expectedctc";
	return false;
}
